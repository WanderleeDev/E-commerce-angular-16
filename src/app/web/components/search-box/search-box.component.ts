...
import { VoiceSearchProService } from '../../services/voiceSearchPro/voice-search-pro.service';
...
export class SearchBoxComponent implements OnInit, AfterViewInit {
  ...
  constructor (
    private voiceSearchProSvc: VoiceSearchProService
  ){}
  ...
  ngOnInit(): void {
    ...
    this.voiceSearchProSvc.getMessage$().subscribe(res => this.messageTranscript = res)
  }
